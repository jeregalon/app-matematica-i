            ...
            Surface(
                ...
                Column(modifier = Modifier.fillMaxSize()) {
                    ...
                    OutlinedTextField(
                        ...
                        label = { androidx.compose.material.Text(text = "Nombre de usuario") },
                    ...
                    NormalTextComponent(
                        value = stringResource(id = R.string.accountAlready),
                        color = Color.Black,
                        fontWeight = FontWeight.Bold,
                        fontSize = 20.sp,
                        paddingTop = 10.dp)
                ...
                when (userState) {
                    ...
                    is UserState.Success -> {
                        ...
                        if (loading && buttonClicked) {
                            ...
                            if (currentUserState.startsWith("Registered successfully!")) {
                                dialogText = "¡Usuario registrado exitosamente!"
                            } else {
                                dialogText = message
                            }
                    ...
                    is UserState.Error -> {
                        ...
                        if (loading && buttonClicked) {
                            ...
                            if (currentUserState.startsWith("Anonymous")) {
                                dialogText = "Por favor, proporcione un correo electrónico."
                            } else if (currentUserState.startsWith("Unable to validate")) {
                                dialogText = "Formato de email incorrecto."
                            } else if (currentUserState.startsWith("Password should be")) {
                                dialogText = "La contraseña debe tener al menos 6 caracteres"
                            ...
                            } else if (currentUserState.startsWith("Signup requires a valid password")) {
                                dialogText = "Por favor, proporcione una contraseña."
                            } else if (currentUserState.startsWith("User already registered")) {
                                dialogText = "El usuario ya está registrado."
                            } else {
                                dialogText = message
                            }
